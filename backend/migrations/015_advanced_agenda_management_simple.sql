-- Migration: Advanced Agenda Management System (Simple)
-- Created: 2025-08-30
...
ADD COLUMN `break_between_slots` INT NOT NULL DEFAULT 0;

-- Agregar índices
ALTER TABLE `availabilities`
ADD INDEX `idx_availability_template` (`template_id`),
ADD INDEX `idx_availability_optimization` (`optimization_score`),
ADD INDEX `idx_availability_date_doctor` (`date`, `doctor_id`);
