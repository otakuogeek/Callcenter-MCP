  ...
  return (
    <div className="space-y-6">
      ...
      <EnhancedStaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-6" delay={200}>
        ...
        <Card className="lg:col-span-2 border-medical-200">
          <CardHeader>
            <CardTitle className="text-medical-800">Llamadas Recientes</CardTitle>
            <CardDescription>Actividad en tiempo real</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {recentCalls.map((call) => (
                <div key={call.id} className="flex items-center justify-between p-3 bg-medical-50 rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs text-medical-500">{call.time}</span>
                  </div>
                </div>
              ))}
            </div>
